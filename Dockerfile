...
CMD ["--config", "config/full_sim_with_factors_IA_only.yaml", "--allow-stimulation", "--num-runs", "100", "--nest-threads", "1", "--max-workers", "64", "--pre-phase-seconds", "900",  "--post-phase-seconds", "900"]