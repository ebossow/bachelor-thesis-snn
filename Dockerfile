...
CMD ["--config", "config/full_sim_with_factors.yaml", "--allow-stimulation", "--num-runs", "100", "--nest-threads", "6", "--max-workers", "10", "--pre-phase-seconds", "300",  "--post-phase-seconds", "300"]