...
def main():
    ...
    # ----- Pick Analysis: -----
    print_dt_suggestions = True
    p0_analysis = True
    neuron_wise_analysis = False
    plot_isi_distributions = False
    plot_avalanche_size_distribution = False
    ...
    # ------------------------------------------------------------------
    if p0_analysis:
        dt_list = np.array([7.0, 10.0, 15.0, 17.0, 20.0, 25.0])
    ...
    # ------------------------------------------------------------------
    if plot_avalanche_size_distribution:
